...
class AgentRunner:
    ...
    async def run(self):
        ...
        while True:
            ...
            current_agent, input_items = await self.run_once(current_agent, input_items, user_input)

    async def run_once(self, current_agent, input_items, user_input):
        ...
        return (current_agent, input_items)
